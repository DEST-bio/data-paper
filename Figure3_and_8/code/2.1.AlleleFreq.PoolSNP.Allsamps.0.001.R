...
#User defined imput
priv.dt <- fread("PoolSNP.AllSamps.0.001.delim") #file
ind.filter <- "AllSamps" #good.samps, all.samps
caller <- "PoolSNP" #PoolSNPs, SNAPE
maf_thresh <- 0.001 #0.001, 0.05

# "PoolSNPs good.samps 0.001" [Submitted]
# "PoolSNPs all.samps 0.001"  [This one]
# "PoolSNPs good.samps 0.05"  
# "PoolSNPs all.samps 0.05"   
