...
pops <- names(fread("bcftools view -S ./good.samps.txt /project/berglandlab/DEST/vcf/dest.PoolSeq.SNAPE.NA.NA.10Nov2020.ann.vcf.gz | head -n 40",
...
ggsave("test.SNAPE.1.png", test.1, height = 3, width = 6)
...
ggsave("test.SNAPE.2.png", test.2, height = 3, width = 6)
